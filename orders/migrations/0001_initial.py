...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('shop_app', '0002_product_discount'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_DEFAULT, to='shop_app.product', verbose_name='Продукт')),
            ],
            options={
